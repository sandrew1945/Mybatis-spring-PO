...
public class SqlSessionTemplate implements SqlSession
{
	...
	{
		return this.sqlSessionProxy.select(po, callback);
	}
	...
	{
		return this.sqlSessionProxy.insert(po);
	}
	...
	@Override
	public int update(Object condPO, Object valuePO)
	{
		return this.sqlSessionProxy.update(condPO, valuePO);
	}
	...
	{
		return this.sqlSessionProxy.delete(po);
	}
